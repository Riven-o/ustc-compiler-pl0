...
symset uniteset_mul(symset s1, .../* NULL */)													// e1
{
    va_list list;
    symset s = s1;
...
void setinsert_mul(symset s, .../* SYM_NULL */)													// e1
{
    va_list list;
    int elem;
...
symset expandset(symset s, .../* SYM_NULL */)													// e1
{
    va_list list;
    symset p;
    int elem;
...
void deleteset(symset s, .../* SYM_NULL */)														// e1
{
    va_list list;
    symset p;
    int elem;
